...
export default function Attendance() {
  return (
    <>
      ...
      <PageHeader
        title="Attendance"
        subtitle="View your attendance details and records."
      />
      <div className="card p-6">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-erp-muted dark:text-erp-dark-text max-w-sm">
            We couldn't find any data for Attendance at this moment. Please check back later or contact your school administration.
          </p>
        </div>
      </div>
    </>
