...
export default function Login() {
  ...
  return (
    <>
      <Helmet><title>Student Login — {APP_NAME}</title></Helmet>
      ...
      >
        ...
        <div className="text-center mb-8">
          <motion.div
            ...
            className="w-16 h-16 gradient-primary rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-btn"
          >
          ...
          <p className="text-sm text-erp-muted dark:text-erp-dark-text mt-1">Student Portal</p>
        </div>
        ...
        <div className="card p-8 space-y-6 bg-white dark:bg-erp-dark-card shadow-modal">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`form-input pl-10 ${errors.email ? 'border-danger focus:ring-red-100' : ''}`}
                  {...register('email')}
                />
              </div>
              {errors.email && (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`form-input pl-10 pr-10 ${errors.password ? 'border-danger focus:ring-red-100' : ''}`}
                  {...register('password')}
                />
                <button
                  type="button"
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" id="remember" className="w-4 h-4 rounded text-primary border-erp-border" />
              <label htmlFor="remember" className="text-sm text-erp-text dark:text-erp-dark-text cursor-pointer">
          ...
          <div className="rounded-xl bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800 p-4">
            ...
            <p className="text-xs text-primary-600 dark:text-primary-400">
              Email: <span className="font-mono">student@eduerp.com</span>
            </p>
            <p className="text-xs text-primary-600 dark:text-primary-400">
