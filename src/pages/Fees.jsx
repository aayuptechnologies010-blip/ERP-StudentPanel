...
export default function Fees() {
  return (
    <>
      ...
      <PageHeader
        title="Fees"
        subtitle="View your fees details and records."
      />
      <div className="card p-6">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-erp-muted dark:text-erp-dark-text max-w-sm">
            We couldn't find any data for Fees at this moment. Please check back later or contact your school administration.
          </p>
        </div>
      </div>
    </>
